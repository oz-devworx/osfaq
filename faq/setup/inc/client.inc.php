...
/* *************************************************************************
  ...
  Install. Checks for the client side FAQ integration files and code.
...
?>
<form action="install.php" method="get" enctype="text/plain">
  <input type="hidden" name="faq_step" value="4" />
  <input type="submit" value="<?php echo sprintf(OSFI_STEP, '4'); ?>" />
</form>
<?php
